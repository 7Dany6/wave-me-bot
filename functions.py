...
def throw_buttons():
    ...
    button_snowflake = types.KeyboardButton(_("Again snowstorm{0}").format("\u2744"))
    ...
    keyboards.add(button_location, button_victory, button_snowflake, button_cold, button_snowman, button_fire)
    return keyboards
